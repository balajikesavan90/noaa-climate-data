...
- Progress KPI (`tested_strict`): **3497** (99.2%)
- Weak coverage (`tested_any`, includes wildcard): **3497** (99.2%)
- tested_any from non-wild matches only: **3497** (99.2%)
...
| --- | --- | --- |
| exact_signature | 1534 | 43.5% |
| exact_assertion | 1955 | 55.4% |
...
- Tested-any rows matched by `exact_signature`: **1534** (43.9%)
- Tested-any rows matched by `exact_assertion`: **1955** (55.9%)
...
| width | 1207 | 1178 | 1178 | 1178 | 97.6% | 97.6% | 97.6% |
