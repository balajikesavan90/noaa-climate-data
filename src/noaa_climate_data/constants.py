...
FIELD_RULE_PREFIXES: dict[str, FieldRule] = {
    ...
    "AE": FieldRule(
        code="AE*",
        parts={
            1: FieldPartRule(missing_values={"99"}, quality_part=2, min_value=0, max_value=31),  # days >= .01
            2: FieldPartRule(
                kind="quality",
                agg="drop",
                allowed_quality=QUALITY_FLAGS - {"C"},
            ),
            3: FieldPartRule(missing_values={"99"}, quality_part=4, min_value=0, max_value=31),  # days >= .10
            4: FieldPartRule(
                kind="quality",
                agg="drop",
                allowed_quality=QUALITY_FLAGS - {"C"},
            ),
            5: FieldPartRule(missing_values={"99"}, quality_part=6, min_value=0, max_value=31),  # days >= .50
            6: FieldPartRule(
                kind="quality",
                agg="drop",
                allowed_quality=QUALITY_FLAGS - {"C"},
            ),
            7: FieldPartRule(missing_values={"99"}, quality_part=8, min_value=0, max_value=31),  # days >= 1.00
            8: FieldPartRule(
                kind="quality",
                agg="drop",
                allowed_quality=QUALITY_FLAGS - {"C"},
    ...
    "AK": FieldRule(
        code="AK1",
        parts={
            1: FieldPartRule(missing_values={"9999"}, quality_part=4, min_value=0, max_value=1500),  # depth cm
            2: FieldPartRule(
                kind="categorical",
                agg="drop",
                missing_values={"9"},
    ...
    "AL": FieldRule(
        code="AL*",
        parts={
            1: FieldPartRule(missing_values={"99"}, agg="drop", min_value=0, max_value=72),  # period hours
            2: FieldPartRule(
                missing_values={"999"},
                quality_part=4,
                agg="sum",
    ...
    "AN": FieldRule(
        code="AN1",
        parts={
            1: FieldPartRule(missing_values={"999"}, agg="drop", min_value=1, max_value=744),  # period hours
            2: FieldPartRule(
                scale=0.1,
                missing_values={"9999"},
                quality_part=4,
    ...
    "AJ": FieldRule(
        code="AJ*",
        parts={
            1: FieldPartRule(missing_values={"9999"}, quality_part=3, min_value=0, max_value=1200),
            2: FieldPartRule(
                kind="categorical",
                agg="drop",
                missing_values={"9"},
    ...
    "KE1": FieldRule(
        code="KE1",
        parts={
            1: FieldPartRule(missing_values={"99"}, quality_part=2, min_value=0, max_value=31),
            2: FieldPartRule(
                kind="quality",
                agg="drop",
                allowed_quality={"0", "1", "2", "3", "4", "5", "6", "7", "9"},
            ),
            3: FieldPartRule(missing_values={"99"}, quality_part=4, min_value=0, max_value=31),
            4: FieldPartRule(
                kind="quality",
                agg="drop",
                allowed_quality={"0", "1", "2", "3", "4", "5", "6", "7", "9"},
            ),
            5: FieldPartRule(missing_values={"99"}, quality_part=6, min_value=0, max_value=31),
            6: FieldPartRule(
                kind="quality",
                agg="drop",
                allowed_quality={"0", "1", "2", "3", "4", "5", "6", "7", "9"},
            ),
            7: FieldPartRule(missing_values={"99"}, quality_part=8, min_value=0, max_value=31),
            8: FieldPartRule(
                kind="quality",
                agg="drop",
                allowed_quality={"0", "1", "2", "3", "4", "5", "6", "7", "9"},
    ...
    "GP1": FieldRule(
        ...
        parts={
            ...
            2: FieldPartRule(missing_values={"9999"}, min_value=0, max_value=9998),
            3: FieldPartRule(
                kind="categorical",
                agg="drop",
                missing_values={"99"},
            ...
            4: FieldPartRule(missing_values={"999"}, min_value=0, max_value=100),
            5: FieldPartRule(missing_values={"9999"}, min_value=0, max_value=9998),
            6: FieldPartRule(
                kind="categorical",
                agg="drop",
                missing_values={"99"},
            ...
            7: FieldPartRule(missing_values={"999"}, min_value=0, max_value=100),
            8: FieldPartRule(missing_values={"9999"}, min_value=0, max_value=9998),
            9: FieldPartRule(
                kind="categorical",
                agg="drop",
                missing_values={"99"},
            ...
            10: FieldPartRule(missing_values={"999"}, min_value=0, max_value=100),
        },
    ),
    "GQ1": FieldRule(
        code="GQ1",
    ...
    "IC1": FieldRule(
        code="IC1",
        parts={
            1: FieldPartRule(missing_values={"99"}, min_value=1, max_value=98),
            2: FieldPartRule(
                missing_values={"9999"},
                quality_part=4,
                min_value=0,
